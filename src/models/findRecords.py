...
class FindRecord(Base):
    ...
    currentLocationID = Column(Integer, ForeignKey('police_stations.id'), nullable=False)
    ...
    current_location = relationship("PoliceStation", backref="find_records")
